...
**Mean FSPE ratio: 0.64** (6/8 proteins show ratio < 1.0). **Protein-level test (n = 15): 13/15 below 1.0, sign test p = 0.0037, permutation p = 0.0002.** A residue-pooled Mann–Whitney gives p = 4.5 × 10⁻¹⁰ but treats residues within a protein as independent; descriptive only. Tetanus LC and BoNT-A reach per-protein significance (both p < 0.0001, r = 1.00); Cholera and Streptolysin O are nominally significant (p = 0.014 and 0.025). *(BoNT-A re-keyed P10844 to P0DPI1; the prior P10844 was BoNT type B. See the [data corrections log](https://github.com/jang1563/narrow-model-safety-eval/blob/main/docs/DATA_CORRECTIONS.md).)*
